        ...
        <DndProvider backend={HTML5Backend}>
          <div className="size-full flex flex-col">
            <Routes>
              ...
              <Route path="/designs/:designId/component/:componentId" element={<ComponentDetailPage />} />
              <Route path="/designs/:designId/component/:componentId/edit" element={<ComponentEditPage />} />
            </Routes>
          </div>
          <Toaster />
        </DndProvider>
