...
import type { User, Endpoint } from "../definitions";
...
export default function APIDetail() {
  ...
  const apiId: string = urlParams.get("id") || "";
  ...
  const createEndpointMutation = useMutation({
    mutationFn: (data: Omit<Endpoint, "id" | "api_id">) =>
  ...
  const handleSubmitEndpoint = (data: Omit<Endpoint, "id" | "api_id">) => {
    if (editingEndpoint) {
